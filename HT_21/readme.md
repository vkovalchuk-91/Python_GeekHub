...
Сторінка редагування продукта повинна бути функціональною. Тобто щоб можна було, наприклад, змінити назву або ціну - тощо. Там же на тій сторінці може бути кнопка "Оновити з магазину" - щоб запустити скрейпінг тільки для цього продукта.